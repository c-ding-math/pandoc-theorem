...
/* package pandoc-theorem-0.1.0.0 */
#ifndef VERSION_pandoc_theorem
#define VERSION_pandoc_theorem "0.1.0.0"
#endif /* VERSION_pandoc_theorem */
#ifndef MIN_VERSION_pandoc_theorem
#define MIN_VERSION_pandoc_theorem(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_pandoc_theorem */
...
/* package pandoc-types-1.23.1.1 */
#ifndef VERSION_pandoc_types
#define VERSION_pandoc_types "1.23.1.1"
...
#define CURRENT_COMPONENT_ID "pandoc-theorem-0.1.0.0-inplace-pandoc-theorem"
